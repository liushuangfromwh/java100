 ...
 */
@RestController
@RequestMapping("CopyOnWriteArrayListDemoController")
public class CopyOnWriteArrayListDemoController {

    private static final Logger log = LoggerFactory.getLogger(CopyOnWriteArrayListDemoController.class);
